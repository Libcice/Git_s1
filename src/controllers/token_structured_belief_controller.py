...
class TokenStructuredBeliefMAC:
    """Current-step token controller with transformer memory and structured belief."""
    ...
    def forward(self, ep_batch, t, test_mode=False):
        ...
        self.slot_q_feats = slot_q_feats.view(bs, self.n_agents, self.args.enemy_num, -1)
    ...
    def get_slot_q_feats(self):
        return self.slot_q_feats
