...
class TokenTransformerBeliefMAC:
    """MAC for token-transformer belief experiments.

    This path now consumes only current-step tokens. The only carried
    temporal state is the latent memory hidden state inside the agent.
    """
