...
class HistorySlotBeliefMAC:
    """MAC for current-step transformer + persistent enemy belief slots."""
    ...
    def forward(self, ep_batch, t, test_mode=False):
        bs = ep_batch.batch_size
        current = self._build_step_tokens(ep_batch, t)
        ...
        agent_outs, new_hidden, new_slots, prior_mu, prior_logvar, prior_u, belief_mu, belief_logvar, belief_u = self.agent(
            current,
            belief_slots,
            hidden,
        )
        ...
        self.prior_belief_u = prior_u.view(
            bs,
            self.n_agents,
            self.args.enemy_num,
    ...
    def init_hidden(self, batch_size):
        ...
        self.belief_slots = self.agent.init_belief().unsqueeze(0).expand(batch_size, self.n_agents, -1, -1).clone()
        self.belief_mu = None
        self.belief_logvar = None
        self.belief_u = None
        self.prior_belief_mu = None
