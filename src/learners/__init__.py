...
from .q_learner_token_belief_filter import QLearnerTokenBeliefFilter
REGISTRY["q_learner_token_belief_filter"] = QLearnerTokenBeliefFilter
...
try:
    ...
    QLearnerTokenLatentResidualBelief = None
if QLearnerTokenLatentResidualBelief is not None:
    REGISTRY["q_learner_token_latent_residual_belief"] = QLearnerTokenLatentResidualBelief
